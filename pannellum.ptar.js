...
window.pannellum = function (E, g, p) {
    function Ba(s, k) {
        ...
        function l(a) {
            ...
            for (var e in b)
                if (b.hasOwnProperty(e)) switch (e) {
                    ...
                    case "author":
                        var h = D(b[e]);
                        b.authorURL && (h = g.createElement("a"), h.href = I(b.authorURL, !0), h.target = "_parent", h.innerHTML = D(b[e]), h = h.outerHTML);
        ...
        fa.innerHTML = '<a href="https://online.library.uitm.edu.my/tourbuilder/" target="_blank">PTAR Virtual Tour Builder</a> 1.0.2';
        J.appendChild(fa);
        ...
        this.removeHotSpot = function (a, c) {
            if (c === p || b.scene ==
                ...
                for (d = 0; d < k.scenes[c].hotSpots.length; d++)
                    if (k.scenes[c].hotSpots[d].hasOwnProperty("id") && k.scenes[c].hotSpots[d].id === a) return k.scenes[c].hotSpots.splice(d, 1), !0
            } else return !1
        };
        this.resize = function () {
            C && z()
